...
const GetStartedSection = () => {
  return (
    <div className={`${font.className} bg-white mt-24 flex flex-col justify-center items-center`}>
        ...
        <p className='text-center mt-10 max-w-5xl text-xl'>If you’re ready to start publishing your work, Silver Gate Publishing can help! With customized feedback and attentive customer service, we help your publishing dreams come to fruition. Together, we will:</p>
        <div className='flex justify-center space-x-16 mt-16 items-center'>
