...
const GetStartedSection = () => {
  return (
    <div className={`${font.className} bg-white mt-24 flex flex-col justify-center items-center`}>
        ...
        <p className='text-center mt-10 max-w-3xl md:max-w-5xl text-md md:text-xl'>If you’re ready to start publishing your work, Palm Bay Publishing can help! With customized feedback and attentive customer service, we help your publishing dreams come to fruition. Together, we will:</p>
