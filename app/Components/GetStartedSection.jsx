...
const GetStartedSection = () => {
  return (
    <div className={`${font.className} bg-white mt-24 flex flex-col justify-center items-center`}>
        <h1 className='text-2xl md:text-5xl'>
            How To Get Started
        </h1>
        <hr className="w-24 md:w-32 mt-6 border-2 border-yellow-600" />
        <p className='text-center mt-10 max-w-3xl md:max-w-5xl text-md md:text-xl'>If you’re ready to start publishing your work, Silver Gate Publishing can help! With customized feedback and attentive customer service, we help your publishing dreams come to fruition. Together, we will:</p>
        <div className='flex flex-col md:flex-row justify-center md:space-x-16 mt-16 items-center'>
