  ...
  return (
    <div className={`${font.className} flex flex-col text-white justify-center items-center customgreen p-8`}>
      ...
      <p className="text-xl max-w-5xl text-center pt-8">
        Palm Bay isn’t just a self publisher – our goal is to be your partner, helping you step-by-step from raw manuscript to publishing success. When it comes to value and experience, Palm Bay Publishing is the best in the industry.
      </p>
