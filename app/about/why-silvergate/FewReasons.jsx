...
const FewReasons = () => {
  return (
    <div className={`${font.className} flex flex-col justify-center items-center p-20`}>
        ...
        <p className='text-center mt-8 text-xl max-w-4xl'>At Silver Gate, we are committed to making your publishing journey as smooth and successful as possible. Here are a few reasons why you should choose us:</p>
