...
const page = () => {
  return (
    <div className={`${font.className} min-h-screen flex flex-col`}>
      ...
      {/* New Section: Self-Publish Your Autobiography With Silver Gate Publishing */}
      <section className="py-20 px-14 customgreen text-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-center">
            Self-Publish Your Autobiography With Silver Gate Publishing
          </h2>
          <div className="border-b-2 border-yellow-600 w-40 mx-auto mb-6"></div>
          <p className="text-lg leading-relaxed mb-6 text-center">
            Writing an autobiography offers a rewarding but challenging journey. Fortunately, you don’t need to embark on this trip alone. Silver Gate Publishing is a top-tier publishing company that can help you achieve your dream of publishing your autobiography.
          </p>
          ...
          <ul className="list-disc list-inside text-lg leading-relaxed mb-6 mx-auto max-w-3xl">
            ...
            <li className="mb-2">
              <span className="font-bold">Book Printing:</span> Silver Gate Publishing works with the highest quality printers to transform your manuscript into a polished final product. We can also format and print your autobiography as an ebook, increasing your potential audience.
            </li>
            <li className="mb-2">
          ...
          <p className="text-lg leading-relaxed text-center">
            Are you ready to make your dream of publishing an autobiography a reality? Contact Silver Gate Publishing today to learn more about how we can help you self-publish your book.
          </p>
        </div>
      </section>
