      ...
      <div className="mx-auto py-6">
        <section className="mb-12 px-14">
          ...
          <p className="text-black text-lg leading-relaxed mt-4">
            How to write a fiction novel and publishing that novel requires creativity, effort, and time. Luckily, there are plenty of resources available to help you develop your book from a simple idea to a polished product. The experts at Palm Bay Publishing can assist you with every step of the publishing process for your fiction book.
          </p>
        </section>
