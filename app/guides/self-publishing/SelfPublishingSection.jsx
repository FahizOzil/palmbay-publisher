  ...
  return (
    ...
    <div className={`${font.className} relative mt-48 flex flex-col md:flex-row w-full px-4 lg:px-16 py-12 gap-8`}>
      ...
      <div className="w-full text-xl md:w-2/4">
        ...
        <p className="mt-2 text-gray-700">
        Beta readers are volunteers who read your manuscript and offer feedback. We don’t provide beta readers at Palm Bay, but if you can find one, they can provide valuable feedback to refine your final draft. The Write Life recommends beta readers who are:
        </p>
      ...
      <p className='text-yellow-600 mt-12 text-3xl text-center'>Step</p>
        ...
        <p className="mt-2 text-gray-700">
        Securing an ISBN is a fundamental aspect of book metadata. These identifiers are assigned to individual books and are essential for proper cataloging and identification in the publishing industry. Palm Bay will help you obtain your ISBN.
        </p>
        <h3 className="text-2xl uppercase text-yellow-600 mt-6">
        BISAC Codes
        </h3>
        <p className="mt-2 text-gray-700">
        BISAC codes help categorize your book by genre and subject. Choosing the most relevant BISAC codes increases your book’s visibility in online retailers and libraries, making it easier for readers to find. Palm Bay will discuss these codes with you to help you choose one that accurately represents the content in your book.
        </p>
        <p className='text-yellow-600 mt-12 text-3xl text-center'>Step</p>
        ...
        <p className="mt-2 text-gray-700">
        Palm Bay makes it easy to publish your book in any format. With us, you can ensure your book reaches your readers in whatever format they prefer!
        </p>
        <p className='text-yellow-600 mt-12 text-3xl text-center'>Step</p>
        ...
        <p className="mt-6 text-gray-700">
        Another option is to outsource your distribution. If you print through Palm Bay, we work with retailers on your behalf. Palm Bay distributes print books to more than 40,000 retail stores and libraries across the world, including Barnes & Noble and Amazon. E-books also make it to the top platforms, including:
        </p>
        <p className='text-yellow-600 mt-12 text-3xl text-center'>Step</p>
        ...
        <p className="mt-6 text-gray-700">
        You can design and publish your website yourself or hire an expert. Palm Bay’s designers are ready to help. You can also check out this blog for more advice on improving your website.
        </p>
        <h3 className="text-2xl uppercase text-yellow-600 mt-6">
        Press Releases
        </h3>
        ...
        <p className="mt-6 text-gray-700">
        Palm Bay offers press release writing and distribution a la carte or as part of a book marketing package. Drawing on a network of more than 780,000 media outlets, Palm Bay’s professionals will send your announcement to as many as 1,000 media outlets.
        </p>
        <h3 className="text-2xl uppercase text-yellow-600 mt-6">
        Reviews
        </h3>
        ...
        <p className="mt-6 text-gray-700">
        We don’t offer review services at Palm Bay, but we suggest including them in your marketing efforts. Consider asking your readers to go to your favorite platform to leave reviews for your book. You can also pay for book reviews through companies like Kirkus Reviews.
        </p>
        <h3 className="text-2xl uppercase text-yellow-600 mt-6">
        Author Events
        </h3>
        ...
        <p className="mt-4 text-gray-700">
        The world of self-publishing is much easier to navigate with a knowledgeable partner like Palm Bay Publishing. Palm Bay is a top-tier company with expert staff in all aspects of book publishing, from copy editing to book marketing.
        </p>
        <p className="mt-6 text-gray-700">
        Working with Palm Bay lets you focus on what you know best — your book and its audiences. You have the freedom to market and print with Palm Bay or handle those aspects on your own, trusting us with only the essentials of interior formatting and cover design.
        </p>
        <p className="mt-6 text-gray-700">
