  ...
  return (
    <div className={`${font.className} mt-20`}>
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-black px-4 text-center">
          ...
          Our service helps you publish a high-quality audiobook without breaking the bank. You can also set your narrator preferences based on gender, accent, and tone of voice. We pair you with the perfect narrator to bring your book to life. Once complete, Silver Gate helps you sell your audiobook through
          </p>
