  ...
  return (
    <div className={`${font.className}`}>
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-black px-4 text-center">
          ...
          At Silver Gate Publishing, we love the passion and artistry that is so common among self-publishing authors. We put our authors first and take pride in bringing your amazing stories to life. 
          </p>
          <p className="pt-4 text-md md:text-xl max-w-3xl">
