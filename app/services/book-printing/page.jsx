    ...
    <div className={`${font.className}`}>
      ...
      <div className="relative  w-full min-h-[40rem] bg-cover bg-center" style={{ backgroundImage: "url('/whitewood.png')" }}>
        <div className="absolute inset-0 flex flex-col justify-center items-center bg-white text-black px-4 text-center">
          ...
          <p className="pt-8 text-xl max-w-3xl">When you’re ready to transform your words into a tangible work of art, Palm Bay Publishing is your trusted partner for premium book printing services. We take pride in printing the highest-quality books and provide a seamless and exceptional printing experience for independent authors, bringing your words to life on the canvas of a professionally printed book.</p>   
