...
const MarketingProcess = () => {
  return (
    <div className={`${font.className} flex flex-col justify-center items-center`}>
            ...
            <h1 className='text-3xl mt-10 md:text-5xl text-center'>How Palm Bay's Marketing Process Work</h1>
            <p className='mt-6 text-xl text-center max-w-4xl'>When you partner with Palm Bay Publishing for your book marketing services, you open the door to a dynamic process that propels your creation into the spotlight.</p>
